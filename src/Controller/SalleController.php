...
class SalleController extends AbstractController
{
    ...
    #[Route('/listSeance/{id}', name: 'list_Seance', methods: ['GET', 'POST'])]
    public function listseance(Request $request, SeanceRepository $seanceRepository, Salle $salle): Response
    {
        $seances = $seanceRepository->findBy([
                'salle'=>$salle

        ]);
        return $this->renderForm('salle/listSeance.html.twig', [
            'seances' => $seances,
             'salle'=>$salle  
            ]);
}
